  ...
  theme: {
    extend: {
      colors: {
        ...
        // Brand — rose refinado con más saturación en mid-tones
        brand: {
          50: '#fff0f3',
          100: '#ffe1e7',
          200: '#ffc6d2',
      ...
      boxShadow: {
        'glow-sm': '0 0 20px -8px rgba(245, 53, 106, 0.4)',
        glow: '0 0 50px -12px rgba(245, 53, 106, 0.55)',
        'glow-lg': '0 0 80px -15px rgba(245, 53, 106, 0.6)',
        ...
        'ring-brand': '0 0 0 3px rgba(245, 53, 106, 0.25)',
      },
      backgroundImage: {
        'gradient-brand': 'linear-gradient(135deg, #ff6a8e 0%, #e01a53 55%, #8f0a35 100%)',
