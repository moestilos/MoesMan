        ...
        {entries.map((e) => {
          ...
          return (
            <a
              ...
              className="group relative flex-none w-[200px] sm:w-[240px] snap-start overflow-hidden rounded-xl bg-bg-card ring-1 ring-border transition hover:-translate-y-1 hover:ring-brand-500/50 hover:shadow-card"
            >
